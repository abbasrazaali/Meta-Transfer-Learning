...
# Description  : prepare food dataset
#==============================================================================
...
def food_data_preparation(corpus_dir, data_dir, dataset):
    try:
        ...
        train_files = []
        test_files = []
        with open(corpus_dir + 'meta/train.txt', 'r') as train_file:         # split
            for line in re.split('\r?\n', train_file.read()):
                train_files.append(line.lower())

        with open(corpus_dir + 'meta/test.txt', 'r') as test_file:         # split
            for line in re.split('\r?\n', test_file.read()):
